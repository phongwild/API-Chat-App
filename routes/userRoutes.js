...
router.route('/send-friend-request')
    .post(catchAsync(user.sendFriendRequest));


router.route('/accept-friend-request')
    .post(catchAsync(user.acceptFriendRequest));


router.route('/decline-friend-request')
    .post(catchAsync(user.declineFriendRequest));


router.route('/remove-friend')
    .post(catchAsync(user.removeFriend));

    
router.route('/getuserbyid')
    .get(catchAsync(user.getUserByID));

router.route('/putfcmtoken/:userID')
    .put(catchAsync(user.putFcmToken));

router.route('/get-friend-list')
    .get(catchAsync(user.getFriendsList));
